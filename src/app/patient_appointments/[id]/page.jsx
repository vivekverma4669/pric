...
import AppointmentItem from "@/components/PatientAppointment/AppointmentItem";
...
const AppointmentListPage = () => {
  ...
  return (
    <div className="flex flex-col items-center pb-32 bg-white max-md:pb-24">
      ...
      <button className="relative self-center px-16 py-5 lg:px-10 mt-11 max-w-full text-base font-bold text-center text-white bg-orange-400 border border-orange-400 rounded-[800px] w-[560px] group overflow-hidden transition-transform transform active:scale-95">
