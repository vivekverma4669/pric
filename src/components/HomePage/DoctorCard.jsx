...
const DoctorCard = ({ image, name, specialization, experience, isActive }) => {
  return (
    <div className={`flex flex-col items-center self-start px-16 py-12 text-orange-400 bg-white rounded-lg shadow-[0px_8px_16px_rgba(0,0,0,0.15)] max-md:px-5  bg-orange-400'}`}>
      <Image
        src={image}
        alt={name}
        width={128}
      ...
      <span className='mt-6 font-medium text-center'> {isActive ? "" :  "London England" }</span> <br/>
      {experience} years experience</div>
