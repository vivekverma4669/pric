      ...
      <div className="flex gap-5 max-md:flex-col">
        <div className="flex flex-col w-[50%]  max-md:w-full  ">
          <div className="flex relative flex-col mt-20  font-bold text-amber-200 max-md:mt-10 max-md:max-w-full">
            ...
            <button className="self-start px-12 py-6 mt-2.5 text-sm text-center text-white bg-amber-200 border border-amber-200 border-solid rounded-[800px] max-md:px-5">
              Make an Appointment
            </button>
          </div>
        </div>
